...
export const noncePda = (intentType: IntentType, user: Address) =>
  findPda([toNonceSeed[intentType], user], intentTransferProgramId);

export const feeConfigPda = (mint: Address) =>
  findPda(["fee_config", mint], intentTransferProgramId);

export const intentTransferPda = findPda("intent_transfer", intentTransferProgramId);
...
export function composeIntraChainIntentTransferIx(addresses: CommonAddressesIxImpl) {
  ...
  return composeIx(accounts, intentTransferIxLayout, undefined, intentTransferProgramId);
}

export const expectedNttConfigPda = (mint: Address) =>
  findPda(["expected_ntt_config", mint], intentTransferProgramId);

export const intermediateTokenPda = (source: Address) =>
  findPda(["bridge_ntt_intermediate", source], intentTransferProgramId);
...
export function composeBridgeIntentIx(
  ...
  const nttAccounts = [
    ...
    [wormholeMessage,          AccountRole.READONLY       ],
...
function commonAccountsImpl(intentType: IntentType, addresses: CommonAddressesIxImpl) {
  ...
  return [
    ...
    [recipient,                AccountRole.READONLY       ], //called destination owner in program
