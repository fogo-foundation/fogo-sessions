...
const depositIxLayout         = byteDiscriminatedLayout( 1, lamportsItem       );
const withdrawIxLayout        = byteDiscriminatedLayout( 2, lamportsItem       );
...
const splitIxLayout           = byteDiscriminatedLayout( 7, lamportsItem       );
const mergeIxLayout           = byteDiscriminatedLayout( 8, []                 );
const moveStakeIxLayout       = byteDiscriminatedLayout( 9, lamportsItem       );
const moveLamportsIxLayout    = byteDiscriminatedLayout(10, lamportsItem       );
...
export function composeInitializeIx(
  ...
  return composeIx(accounts, initializeIxLayout, undefined, sessionStakeProgramId);
}
...
export function composeDelegateIx(
  ...
  return composeIx(accounts, delegateIxLayout, undefined, sessionStakeProgramId);
}
...
export function composeDeactivateIx(
  ...
  return composeIx(accounts, deactivateIxLayout, undefined, sessionStakeProgramId);
}
...
export function composeAuthorizeUserIx(
  ...
  const { user, stake } = addresses;
  const authority = sessionStakeAuthorityPda(user);
  const { newAuthority } = addresses;
  const accounts = [
...
export function composeAuthorizeIntentIx(
  ...
  return composeIx(accounts, authorizeIntentIxLayout, undefined, sessionStakeProgramId);
}
...
export function composeMergeIx(addresses: TransferAddresses) {
  ...
  return composeIx(accounts, mergeIxLayout, undefined, sessionStakeProgramId);
}
