...
export function composeStartSessionIx(
  ...
  return composeIx(accounts, startSessionIxLayout, undefined, sessionManagerProgramId);
}
...
export function composeRevokeSessionIx(
  ...
  return composeIx(accounts, revokeSessionIxLayout, undefined, sessionManagerProgramId);
}
...
export function composeCloseSessionIx(
  ...
  return composeIx(accounts, closeSessionIxLayout, undefined, sessionManagerProgramId);
}
