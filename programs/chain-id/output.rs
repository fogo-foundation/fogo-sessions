...
pub mod program {
    ...
    impl anchor_lang::Id for ChainId {
        fn id() -> Pubkey {
            ID
        }
    }
...
fn dispatch<'info>(
    ...
    if data.starts_with(instruction::Set::DISCRIMINATOR) {
        return __private::__global::set(
            program_id,
            accounts,
            &data[instruction::Set::DISCRIMINATOR.len()..],
        );
    }
...
mod __private {
                        ...
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "programs/chain-id/src/lib.rs",
                                        line: 9u32,
                                    }),
                                ),
    ...
    pub mod __global {
        ...
        pub fn set<'info>(
            ...
            ::solana_msg::sol_log("Instruction: Set");
            let ix = instruction::Set::deserialize(&mut &__ix_data[..])
                .map_err(|_| {
                    anchor_lang::error::ErrorCode::InstructionDidNotDeserialize
                })?;
            let instruction::Set { chain_id } = ix;
            let mut __bumps = <Set as anchor_lang::Bumps>::Bumps::default();
            let mut __reallocs = std::collections::BTreeSet::new();
            let mut __remaining_accounts: &[AccountInfo] = __accounts;
            let mut __accounts = Set::try_accounts(
                __program_id,
...
pub mod instruction {
    ...
    impl borsh::ser::BorshSerialize for Set
    where
    ...
    impl borsh::de::BorshDeserialize for Set
    where
        String: borsh::BorshDeserialize,
    {
        fn deserialize_reader<R: borsh::maybestd::io::Read>(
            ...
            Ok(Self {
                chain_id: borsh::BorshDeserialize::deserialize_reader(reader)?,
            })
        }
    }
    impl anchor_lang::Discriminator for Set {
        const DISCRIMINATOR: &'static [u8] = &[198, 51, 53, 241, 116, 29, 126, 194];
    }
    impl anchor_lang::InstructionData for Set {}
    impl anchor_lang::Owner for Set {
        fn owner() -> Pubkey {
            ID
        }
    }
...
pub mod accounts {
    pub use crate::__client_accounts_set::*;
}
...
#[automatically_derived]
impl<'info> anchor_lang::Accounts<'info, SetBumps> for Set<'info>
where
    'info: 'info,
{
    #[inline(never)]
    fn try_accounts(
        ...
        let __Args { chain_id } = __Args::deserialize(&mut __ix_data)
        ...
        let chain_id_account = &__accounts[0];
        *__accounts = &__accounts[1..];
        let system_program: anchor_lang::accounts::program::Program<System> = anchor_lang::Accounts::try_accounts(
                __program_id,
                __accounts,
        ...
        __bumps.chain_id_account = __bump;
        if chain_id_account.key() != __pda_address {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintSeeds,
                    )
                    .with_account_name("chain_id_account")
                    .with_pubkeys((chain_id_account.key(), __pda_address)),
            );
        }
        let chain_id_account = ({
            #[inline(never)]
            || {
                let actual_field = AsRef::<AccountInfo>::as_ref(&chain_id_account);
                let actual_owner = actual_field.owner;
                let space = 8 + 4 + chain_id.len();
                let pa: anchor_lang::accounts::account::Account<ChainId> = if !false
                    || actual_owner == &anchor_lang::solana_program::system_program::ID
                {
                    let __current_lamports = chain_id_account.lamports();
                    if __current_lamports == 0 {
                        let space = space;
                        let lamports = __anchor_rent.minimum_balance(space);
                        let cpi_accounts = anchor_lang::system_program::CreateAccount {
                            from: sponsor.to_account_info(),
                            to: chain_id_account.to_account_info(),
                        };
                        ...
                        anchor_lang::system_program::create_account(
                            cpi_context.with_signer(&[&[SEED, &[__bump][..]][..]]),
                            lamports,
                            space as u64,
                            __program_id,
                        )?;
                    } else {
                        if sponsor.key() == chain_id_account.key() {
                            return Err(
                                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                    ...
                                    .with_pubkeys((sponsor.key(), chain_id_account.key())),
                            );
                        }
                        ...
                        let cpi_accounts = anchor_lang::system_program::Allocate {
                            account_to_allocate: chain_id_account.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                        ...
                        let cpi_accounts = anchor_lang::system_program::Assign {
                            account_to_assign: chain_id_account.to_account_info(),
                        };
                        let cpi_context = anchor_lang::context::CpiContext::new(
                            system_program.to_account_info(),
                            cpi_accounts,
                    ...
                    match anchor_lang::accounts::account::Account::try_from_unchecked(
                        ...
                        Ok(val) => val,
                        Err(e) => return Err(e.with_account_name("chain_id_account")),
                    }
                } else {
        ...
        if !AsRef::<AccountInfo>::as_ref(&chain_id_account).is_writable {
            return Err(
                anchor_lang::error::Error::from(
                        anchor_lang::error::ErrorCode::ConstraintMut,
                    )
        ...
        if !__anchor_rent
            .is_exempt(
                chain_id_account.to_account_info().lamports(),
                chain_id_account.to_account_info().try_data_len()?,
            )
        {
            return Err(
                anchor_lang::error::Error::from(
...
#[automatically_derived]
impl<'info> anchor_lang::ToAccountInfos<'info> for Set<'info>
where
    'info: 'info,
{
    fn to_account_infos(
        ...
        account_infos.extend(self.chain_id_account.to_account_infos());
        account_infos.extend(self.system_program.to_account_infos());
        account_infos
    }
}
#[automatically_derived]
impl<'info> anchor_lang::ToAccountMetas for Set<'info> {
    fn to_account_metas(
        &self,
        is_signer: Option<bool>,
    ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
        ...
        account_metas.extend(self.chain_id_account.to_account_metas(None));
        account_metas.extend(self.system_program.to_account_metas(None));
        account_metas
    }
}
#[automatically_derived]
impl<'info> anchor_lang::AccountsExit<'info> for Set<'info>
where
    'info: 'info,
{
    fn exit(
        ...
        anchor_lang::AccountsExit::exit(&self.sponsor, program_id)
            .map_err(|e| e.with_account_name("sponsor"))?;
        anchor_lang::AccountsExit::exit(&self.chain_id_account, program_id)
            .map_err(|e| e.with_account_name("chain_id_account"))?;
        Ok(())
    }
}
pub struct SetBumps {
    pub chain_id_account: u8,
}
#[automatically_derived]
impl ::core::fmt::Debug for SetBumps {
    #[inline]
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ::core::fmt::Formatter::debug_struct_field1_finish(
            f,
            "SetBumps",
            "chain_id_account",
            &&self.chain_id_account,
        )
    }
}
impl Default for SetBumps {
    fn default() -> Self {
        SetBumps {
            chain_id_account: u8::MAX,
        }
    }
}
impl<'info> anchor_lang::Bumps for Set<'info>
where
    'info: 'info,
{
    type Bumps = SetBumps;
...
/// To access the struct in this module, one should use the sibling
/// `accounts` module (also generated), which re-exports this.
pub(crate) mod __client_accounts_set {
    use super::*;
    use anchor_lang::prelude::borsh;
    /// Generated client accounts for [`Set`].
    pub struct Set {
        pub sponsor: Pubkey,
        pub chain_id_account: Pubkey,
        pub system_program: Pubkey,
    }
    impl borsh::ser::BorshSerialize for Set
    where
        ...
        Pubkey: borsh::ser::BorshSerialize,
    {
        fn serialize<W: borsh::maybestd::io::Write>(
            ...
            borsh::BorshSerialize::serialize(&self.chain_id_account, writer)?;
            borsh::BorshSerialize::serialize(&self.system_program, writer)?;
            Ok(())
        }
    }
    #[automatically_derived]
    impl anchor_lang::ToAccountMetas for Set {
        fn to_account_metas(
            &self,
            is_signer: Option<bool>,
        ) -> Vec<anchor_lang::solana_program::instruction::AccountMeta> {
...
/// To access the struct in this module, one should use the sibling
/// [`cpi::accounts`] module (also generated), which re-exports this.
pub(crate) mod __cpi_client_accounts_set {
    use super::*;
    /// Generated CPI struct of the accounts for [`Set`].
    pub struct Set<'info> {
        pub sponsor: anchor_lang::solana_program::account_info::AccountInfo<'info>,
        pub chain_id_account: anchor_lang::solana_program::account_info::AccountInfo<
            'info,
        >,
        pub system_program: anchor_lang::solana_program::account_info::AccountInfo<
            'info,
    ...
    impl<'info> anchor_lang::ToAccountMetas for Set<'info> {
        fn to_account_metas(
            ...
            account_metas
                .push(
                    anchor_lang::solana_program::instruction::AccountMeta::new(
                        anchor_lang::Key::key(&self.chain_id_account),
                        false,
                    ),
                );
            account_metas
    ...
    impl<'info> anchor_lang::ToAccountInfos<'info> for Set<'info> {
        fn to_account_infos(
            ...
            account_infos
                .extend(
                    anchor_lang::ToAccountInfos::to_account_infos(&self.chain_id_account),
                );
            account_infos
                .extend(
...
#[automatically_derived]
impl anchor_lang::AccountSerialize for ChainId {
    fn try_serialize<W: std::io::Write>(
        &self,
        writer: &mut W,
    ) -> anchor_lang::Result<()> {
        if writer.write_all(ChainId::DISCRIMINATOR).is_err() {
...
#[automatically_derived]
impl anchor_lang::AccountDeserialize for ChainId {
    fn try_deserialize(buf: &mut &[u8]) -> anchor_lang::Result<Self> {
        if buf.len() < ChainId::DISCRIMINATOR.len() {
            return Err(
                anchor_lang::error::ErrorCode::AccountDiscriminatorNotFound.into(),
            );
        }
        let given_disc = &buf[..ChainId::DISCRIMINATOR.len()];
        if ChainId::DISCRIMINATOR != given_disc {
            return Err(
                anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                        error_name: anchor_lang::error::ErrorCode::AccountDiscriminatorMismatch
                            .name(),
                    ...
                    .with_account_name("ChainId"),
            );
        }
        Self::try_deserialize_unchecked(buf)
    }
    fn try_deserialize_unchecked(buf: &mut &[u8]) -> anchor_lang::Result<Self> {
        let mut data: &[u8] = &buf[ChainId::DISCRIMINATOR.len()..];
        AnchorDeserialize::deserialize(&mut data)
            .map_err(|_| anchor_lang::error::ErrorCode::AccountDidNotDeserialize.into())
    }
}
#[automatically_derived]
impl anchor_lang::Discriminator for ChainId {
    const DISCRIMINATOR: &'static [u8] = &[203, 146, 201, 161, 230, 71, 157, 218];
}
#[automatically_derived]
impl anchor_lang::Owner for ChainId {
    fn owner() -> Pubkey {
        crate::ID
    }
}
