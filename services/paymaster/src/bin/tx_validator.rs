...
impl Network {
    ...
    fn default_ntt_quoter_address(self) -> H160 {
        match self {
            Network::Mainnet => [82, 65, 201, 39, 102, 152, 67, 159, 239, 39, 128, 219, 171, 118, 254, 201, 11, 99, 63, 189],
            Network::Testnet => [165, 64, 8, 1, 121, 65, 236, 233, 104, 98, 58, 13, 216, 238, 144, 126, 43, 19, 53, 150],
        }
    }
}
