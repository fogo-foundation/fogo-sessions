...
use crate::constraint::{
    ...
    InstructionConstraint, DataType, DataValue, TransactionVariation,
...
impl InstructionConstraint {
        ...
        InstructionConstraint {
            ...
            data: vec![
                ...
                DataConstraint {
                    ...
                    constraint: DataConstraintSpecification::EqualTo(vec![DataValue::U8(
                        1,
                    )]),
                },
                // padding = 0
    ...
    pub fn intent_transfer_bridge_ntt_instruction_constraint(ntt_quoter: H160) -> InstructionConstraint {
        InstructionConstraint {
            program: fogo_sessions_sdk::intent_transfer::INTENT_TRANSFER_PROGRAM_ID,
            accounts: vec![],
            data: vec![
                ...
                DataConstraint {
                    ...
                    constraint: DataConstraintSpecification::EqualTo(vec![DataValue::NttSignedQuoter(
                        ntt_quoter,
                    )]),
                }
            ],
...
impl TransactionVariation {
    ...
    pub fn intent_transfer_bridge_ntt_variation(ntt_quoter: H160, max_gas_spend: u64) -> TransactionVariation {
        TransactionVariation::V1(VariationOrderedInstructionConstraints {
            name: "Intent NTT Bridge".to_string(),
            instructions: vec![
                InstructionConstraint::intent_instruction_constraint(),
                InstructionConstraint::intent_transfer_bridge_ntt_instruction_constraint(ntt_quoter),
            ],
            max_gas_spend,
        })
    }
