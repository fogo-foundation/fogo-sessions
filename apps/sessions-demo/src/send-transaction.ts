...
export async function sendTransaction(transaction: Transaction, sponsorPubkey: PublicKey, solanaRpc: string, connection: Connection, sessionKey: Keypair) : Promise<{
    link: string;
